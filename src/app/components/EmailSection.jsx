    ...
    >
      ...
      <div className="z-10">
        ...
        <p className="text-[#ADB7BE] mb-4 max-w-md">
          {" "}
          Agar siz yangi imkoniyatlarni izlayotgan bo'lsangiz yoki savollaringiz bo'lsa, mening pochta qutim doimo ochiq! Har qanday so'rovlar, hamkorlik takliflari yoki shunchaki salom aytishni xohlasangiz, bemalol menga yozing. Men imkon qadar tezroq javob berishga harakat qilaman. Keling, muloqot qilaylik!
        </p>
